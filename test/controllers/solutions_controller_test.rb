...
class SolutionsControllerTest < ActionController::TestCase
  ...
  test "should create solution" do
    assert_difference('Solution.count') do
      post :create, solution: { body: @solution.body, chapter_id: @solution.chapter_id, question_id: @solution.question_id, topic_id: @solution.topic_id }
    end
  ...
  test "should update solution" do
    patch :update, id: @solution, solution: { body: @solution.body, chapter_id: @solution.chapter_id, question_id: @solution.question_id, topic_id: @solution.topic_id }
    assert_redirected_to solution_path(assigns(:solution))
  end
