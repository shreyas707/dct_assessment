...
class BatchesControllerTest < ActionController::TestCase
  ...
  test "should create batch" do
    assert_difference('Batch.count') do
      post :create, batch: { course_id: @batch.course_id, end_date: @batch.end_date, id: @batch.id, start_date: @batch.start_date, title: @batch.title }
    end
  ...
  test "should update batch" do
    patch :update, id: @batch, batch: { course_id: @batch.course_id, end_date: @batch.end_date, id: @batch.id, start_date: @batch.start_date, title: @batch.title }
    assert_redirected_to batch_path(assigns(:batch))
  end
